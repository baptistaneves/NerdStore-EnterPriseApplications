...
public class AuthController : Controller
{
    ...
    private async Task<UsuarioRespostaLogin> GerarJwt(string email)
    {
        ...
        claims.Add(new Claim(JwtRegisteredClaimNames.Nbf, ToUnisEpochDate(DateTime.UtcNow).ToString()));
        claims.Add(new Claim(JwtRegisteredClaimNames.Iat, ToUnisEpochDate(DateTime.UtcNow).ToString(), ClaimValueTypes.Integer64));
